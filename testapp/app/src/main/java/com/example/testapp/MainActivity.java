...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.menu_xemDsCongViec) {
            Toast.makeText(MainActivity.this, "Xem được chưa", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.menu_thongke) {
            Toast.makeText(MainActivity.this, "Thống kê chưa xong", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.menu_caidat) {
            Toast.makeText(MainActivity.this, "Cài đặt", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.menu_goithieu) {
